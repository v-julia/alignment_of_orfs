...
def cds_distr(input_file, output_dir, out_name):
    ...
    with open(input_file) as handle:
        ...
        out_file.write('Records with annotated CDS: {}\n'.format(len(rec_annot_cds)))
        out_file.write('CDS with product fields {}'.format(cds_prod_count))
        out_file.write('CDS with gene fields {}'.format(cds_gene_count))
        
        print('Number of records in file: {}'.format(len(records)))
        print('Records with annotated CDS: {}'.format(len(rec_annot_cds)))
